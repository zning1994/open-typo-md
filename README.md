...
[CONTRIBUTING.md](CONTRIBUTING.md) has the rest: the three rules the code has to hold,
what a change should come with, and why a test that passes on Linux can still be wrong.
